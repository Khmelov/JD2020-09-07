...
public class Test_jd01_06 {
    ...
    public void testTaskB1() throws Exception {
        Test_jd01_06 test_jd01_06;
        test_jd01_06 = run("");
        test_jd01_06.exclude("У");
        test_jd01_06.include("лукоморья");
        test_jd01_06.exclude("зелёный");
        test_jd01_06.include("Златая");
        test_jd01_06.exclude("цепь");
        test_jd01_06.include("на");
        test_jd01_06.include("дубе");
        test_jd01_06.exclude("том");
        test_jd01_06.exclude("днём");
        test_jd01_06.include("ночью");
        test_jd01_06.exclude("кот");
        test_jd01_06.exclude("учёный");
        Test_jd01_06 всё = test_jd01_06.include("Всё");
        test_jd01_06.exclude("ходит");
        Test_jd01_06 цепи = test_jd01_06.include("цепи");
        test_jd01_06.exclude("кругом");
        test_jd01_06.exclude("Идёт");
        test_jd01_06.include("направо");
        test_jd01_06.exclude("песнь");
        test_jd01_06.exclude("заводит");
        test_jd01_06.include("Налево");
        test_jd01_06.include("сказку");
        test_jd01_06.exclude("говорит");
        test_jd01_06.include("чудеса");
        test_jd01_06.exclude("леший");
        test_jd01_06.exclude("бродит");
        test_jd01_06.include("Русалка");
        test_jd01_06.exclude("ветвях");
        test_jd01_06.exclude("сидит");
        test_jd01_06.exclude("неведомых");
        test_jd01_06.exclude("дорожках");
        test_jd01_06.include("Следы");
        test_jd01_06.exclude("невиданных");
        test_jd01_06.exclude("зверей");
        test_jd01_06.exclude("Избушка");
        test_jd01_06.include("на");
        test_jd01_06.exclude("курьих");
        test_jd01_06.exclude("ножках");
        test_jd01_06.exclude("Стоит");
        test_jd01_06.exclude("окон");
        test_jd01_06.exclude("дверей");
        test_jd01_06.exclude("видений");
        test_jd01_06.include("полны");
        test_jd01_06.include("заре");
        test_jd01_06.exclude("прихлынут");
        test_jd01_06.include("волны");
        test_jd01_06.include("На");
        test_jd01_06.exclude("брег");
        test_jd01_06.exclude("песчаный");
        test_jd01_06.exclude("пустой");
        test_jd01_06.exclude("тридцать");
        test_jd01_06.exclude("витязей");
        test_jd01_06.exclude("прекрасных");
        test_jd01_06.exclude("Чредой");
        test_jd01_06.exclude("выходят");
        test_jd01_06.exclude("ясных");
        test_jd01_06.include("ними");
        test_jd01_06.include("дядька");
        test_jd01_06.exclude("морской");
        test_jd01_06.exclude("королевич");
        test_jd01_06.exclude("мимоходом");
        test_jd01_06.exclude("Пленяет");
        test_jd01_06.include("грозного");
        test_jd01_06.include("царя");
        test_jd01_06.exclude("Там");
        test_jd01_06.exclude("облаках");
        test_jd01_06.exclude("перед");
        test_jd01_06.exclude("народом");
        test_jd01_06.exclude("Через");
        test_jd01_06.include("леса");
        test_jd01_06.exclude("через");
        test_jd01_06.include("моря");
        test_jd01_06.exclude("Колдун");
        test_jd01_06.exclude("несёт");
        test_jd01_06.include("богатыря");
        test_jd01_06.include("темнице");
        test_jd01_06.exclude("там");
        test_jd01_06.include("царевна");
        test_jd01_06.exclude("тужит");
        test_jd01_06.exclude("бурый");
        test_jd01_06.exclude("волк");
        test_jd01_06.include("верно");
        test_jd01_06.exclude("служит");
        test_jd01_06.exclude("Там");
        test_jd01_06.include("ступа");
        test_jd01_06.include("Бабою");
        test_jd01_06.exclude("Ягой");
        test_jd01_06.exclude("Идёт");
        test_jd01_06.exclude("бредёт");
        test_jd01_06.include("сама");
        test_jd01_06.exclude("собой");
        test_jd01_06.exclude("царь");
        test_jd01_06.exclude("Кащей");
        test_jd01_06.exclude("златом");
        test_jd01_06.exclude("чахнет");
        test_jd01_06.exclude("русский");
        test_jd01_06.include("Русью");
        test_jd01_06.exclude("пахнет");
        test_jd01_06.exclude("мёд");
        test_jd01_06.include("моря");
        test_jd01_06.exclude("видел");
        test_jd01_06.exclude("зелёный");
        test_jd01_06.exclude("сидел");
        test_jd01_06.exclude("учёный");
        test_jd01_06.include("Свои");
        test_jd01_06.include("мне");
        test_jd01_06.include("сказки");
        test_jd01_06.exclude("говорил");
