...
public class TaskB {
    ...
    public static final String RESULT_TASK_A_TXT = "resultTaskB.txt";
    ...
    private static void getMath(ArrayList<String> strings, String path) {
        ...
        while (matcher.find()){
            //if (temp.add(matcher.group()))
            marks++;}

       // System.out.println(stringBuffer);
        System.out.println("words="+words+", punctuation marks="+marks);
        try (PrintWriter printWriter=new PrintWriter(path+RESULT_TASK_A_TXT)){
