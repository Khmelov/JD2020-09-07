 ...
 * укажите ссылку на Ваш fork https://github.com/ваш_логин/JD2020-09-07;
 * выберите путь к папке проекта (без русских букв и пробелов);
 * укажите имя папки проекта (например JD2020-09-07_verXX - такой папки на диске быть не должно).
 * после создания проекта добавьте upstream https://github.com/Khmelov/JD2020-09-07/ командой VCS -> Git -> Remotes...
